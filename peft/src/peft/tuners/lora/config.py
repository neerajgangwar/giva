...
class LoraConfig(PeftConfig):
    ...
    scale: Optional[str] = field(
        default=None,
        metadata={
            "help": "For scaling A and B after initialization. Possible values: gd, unit, stable, weightS."
        }
    )
    stable_gamma: Optional[float] = field(
        default=None,
        metadata={
            "help": "Required when `scale` is `stable`."
        }
    )
